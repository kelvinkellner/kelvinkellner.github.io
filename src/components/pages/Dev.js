    ...
    render() {
        return(
            ...
            <ProjectDeck>
                ...
                <Project title="MuSpace" role="Front End Software Developer" year="2021" type="Academic Project" tech="React JS, HTML, CSS, Firebase" imgSrc={MuSpaceLogo} imgAlt="MuSpace logo"
                actions={[{
                        message: "View on GitHub",
                ...
                actions={[{
                    ...
                    Planned and prototyped a simple 2D platformer game where you play as a pixel art duck who is adamantly in search of bread. Implemented in Java using OOP.
                </Project>
            </ProjectDeck>
        </div>
        );
