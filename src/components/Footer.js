...
class Footer extends Component {
  render() {
    return (
      <>
        <Container id="footer" style={{ paddingBottom: '22px' }}>
          {/* <div className="row" style={{marginBottom: "1em"}}> */}
          <hr />
          <Row className="justify-content-center">
            <p className="text-center" style={{ marginBottom: '1.2em' }}>
        ...
        <div style={{ width: '100%', height: '22px', display: 'flex' }}>
          <Image
            ...
            style={{ marginTop: '0', width: '100%', objectFit: 'cover', objectPosition: 'bottom' }}
          />
        </div>
      </>
    );
