...
class SocialButtons extends Component { 
    render() {
        ...
        const shiftDown = this.props.shiftDown === undefined ? "2px" : this.props.shiftDown + "px";
        return(
            <Row style={this.props.style}>
                <ul className="nav" style={{width: "100%", display: "flex", justifyContent: (this.props.justifyContent === undefined ? "center" : this.props.justifyContent)}}>
                    <div className="col-social-buttons" style={{margin: "2px " + iconSize/2 + "px"}}>
                        <a href="https://www.linkedin.com/in/kelvinkellner/" rel="noreferrer" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} viewBox="0 0 24 24" style={{margin: "-" + shiftDown + " -8px 0 0"}}>
                            ...
                            <li className="nav-item"><a href="https://www.linkedin.com/in/kelvinkellner/" rel="noreferrer" target="_blank">LinkedIn</a></li>
                    </div>
                    <div className="col-social-buttons" style={{margin: "2px " + iconSize/2 + "px"}}>
                        <a href="https://github.com/kelvinkellner" rel="noreferrer" target="_blank">
                            ...
                            <p className="nav-item"><a href="https://github.com/kelvinkellner" rel="noreferrer" target="_blank">GitHub</a></p>
                    </div>
                    <div className="col-social-buttons" style={{margin: "2px " + iconSize/2 + "px"}}>
                        <a href="https://instagram.com/k.godless/" rel="noreferrer" target="_blank">
                            ...
                            <li className="nav-item"><a href="https://instagram.com/k.godless/" rel="noreferrer" target="_blank">Instagram</a></li>
                    </div>
                    <div className="col-social-buttons" style={{margin: "2px " + iconSize/2 + "px"}}>
                        <a href="mailto:kelvinkellner123@gmail.com" rel="noreferrer" target="_blank">
                            ...
                            <li className="nav-item"><a href="mailto:kelvinkellner123@gmail.com" rel="noreferrer" target="_blank">Email</a></li>
                    </div>
                    <div />
                </ul>
            </Row>
